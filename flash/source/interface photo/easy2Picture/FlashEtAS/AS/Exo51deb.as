package 
{
  //elements graphiques
	...
	public class Exo51deb extends AnimationPleinEcran 
	{
					...
					//Calcule de la note	
						...
						*/
						...
						if (variableObturationJoueur == variableObturationValide) {
							...
							if(variableObturationJoueur==60)
							{
								noteJoueur=noteJoueur+4;
							}
							else
