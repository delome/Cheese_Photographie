package 
{
	...
	public class Exo53exp extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			valeurParfaiteX=127; //valeur de X du cadrage parfait
			valeurParfaiteY=-372; //valeur de Y du cadrage parfait
			valeurParfaiteZoom=54; //valeur de Zoom du cadrage parfait
			
			valeurParfaiteXBis=42; //valeur de X du cadrage parfait (deuxième solution)
			valeurParfaiteYBis=-610; //valeur de Y du cadrage parfait (deuxième solution)
			valeurParfaiteZoomBis=58; //valeur de Zoom du cadrage parfait (deuxième solution)
		...
		{	
			...
			{
				if(monCadre.rotation==0) // Cas ou le joueur ne choisi pas la bonne orientation
				{
