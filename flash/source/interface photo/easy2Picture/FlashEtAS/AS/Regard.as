package {
	...
	public class Regard extends AnimationPleinEcran {
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionRegard);
		...
		private function FonctionRegard(e:MouseEvent)
		{
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo41exp";
