package {
	...
	public class ReglesDesTiers extends AnimationPleinEcran
	{

		var flouImage:BlurFilter = new BlurFilter();
		FilterShortcuts.init();
		
		public function ReglesDesTiers()
		{
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionRegles);
		...
		private function FonctionRegles(e:MouseEvent)
		{
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo11exp";
