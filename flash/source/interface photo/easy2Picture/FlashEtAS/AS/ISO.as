package {
	...
	public class ISO extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionISO);
		...
		private function FonctionISO(e:MouseEvent)
		{
			
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo11deb";
