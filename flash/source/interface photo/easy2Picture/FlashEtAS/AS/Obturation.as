...
//elements graphiques
	...
	public class Obturation extends AnimationPleinEcran {
	

		var flouImage:BlurFilter = new BlurFilter();
		FilterShortcuts.init();
		
		public function Obturation(){
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionObturation);
		...
		private function FonctionObturation(e:MouseEvent){
