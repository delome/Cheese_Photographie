package 
{
	...
	public class Exo11exp extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			valeurParfaiteX=-523; //valeur de X du cadrage parfait
			valeurParfaiteY=-283; //valeur de Y du cadrage parfait
			valeurParfaiteZoom=46; //valeur de Zoom du cadrage parfait
			
			valeurParfaiteXBis=834; //valeur de X du cadrage parfait (deuxième solution)
			valeurParfaiteYBis=-468; //valeur de Y du cadrage parfait (deuxième solution)
			valeurParfaiteZoomBis=48; //valeur de Zoom du cadrage parfait (deuxième solution)
