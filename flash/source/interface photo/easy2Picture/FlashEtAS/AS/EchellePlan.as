package {
	...
	public class EchellePlan extends AnimationPleinEcran
	{

		var flouImage:BlurFilter = new BlurFilter();
		FilterShortcuts.init();
		
		public function EchellePlan()
		{
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionEchelle);
		...
		private function FonctionEchelle(e:MouseEvent)
		{
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo51exp";
