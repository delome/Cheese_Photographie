package {
	...
	public class Diaphragme extends AnimationPleinEcran{
		
		var flouImage:BlurFilter = new BlurFilter();
		FilterShortcuts.init();
		
		public function Diaphragme(){
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionDiaphragme);
		...
		private function FonctionDiaphragme(e:MouseEvent)
		{
