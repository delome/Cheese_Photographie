package 
{
  //elements graphiques
	...
	public class Exo52deb extends AnimationPleinEcran 
	{
		...
		var variableIsoJoueur:int=400;
		var variableWbJoueur:int=4;
		var variableExpoJoueur:Number=1;
		var variableDiaphJoueur:int=2;
		var variableObturationJoueur:int=30;
		
		//Déclaration des bons réglages
		var variableIsoValide:int=100;
		var variableWbValide:int=3;
		var variableExpoValide:Number=0;
		var variableDiaphValide:int=2;
		var variableObturationValide:int=500;
			...
			//Résultat du joueur
				private function calculerNote (e:MouseEvent):void
				{
					...
					//Calcule de la note	
						...
						{
								if(variableExpoJoueur==0.5 || variableExpoJoueur==-0.5)
								{
									noteJoueur=noteJoueur+2;
								}
								else
						...
						*/
						...
						if (variableObturationJoueur == variableObturationValide) {
							noteJoueur=noteJoueur+8;
						} 
						else {
							if(variableObturationJoueur==250)
							{
								noteJoueur=noteJoueur+4;
							}
							else
