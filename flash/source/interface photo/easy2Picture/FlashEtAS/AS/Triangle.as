package {
	...
	public class Triangle extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionTriangle);
		...
		private function FonctionTriangle(e:MouseEvent)
		{
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo31exp";
