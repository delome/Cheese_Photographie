package {
	...
	public class LignesDirectrices extends AnimationPleinEcran
	{

		var flouImage:BlurFilter = new BlurFilter();
		FilterShortcuts.init();
		
		public function LignesDirectrices()
		{
		...
		private function addedToStageHandler (e:Event):void{
			...
			_btnJouer.addEventListener(MouseEvent.CLICK ,FonctionDirectrice);
		...
		private function FonctionDirectrice(e:MouseEvent)
		{
			//sert à définir quel bouton a été cliqué
			var texte:String = "exo21exp";
