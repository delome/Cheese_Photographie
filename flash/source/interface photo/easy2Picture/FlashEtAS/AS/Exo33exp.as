package 
{
	...
	public class Exo33exp extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			valeurParfaiteX=-691; //valeur de X du cadrage parfait
			valeurParfaiteY=-400; //valeur de Y du cadrage parfait
			valeurParfaiteZoom=60; //valeur de Zoom du cadrage parfait
			
			valeurParfaiteXBis=266; //valeur de X du cadrage parfait (deuxième solution)
			valeurParfaiteYBis=-430; //valeur de Y du cadrage parfait (deuxième solution)
			valeurParfaiteZoomBis=52; //valeur de Zoom du cadrage parfait (deuxième solution)
