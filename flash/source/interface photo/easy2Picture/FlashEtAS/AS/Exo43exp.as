package 
{
	...
	public class Exo43exp extends AnimationPleinEcran
	{
		...
		private function addedToStageHandler (e:Event):void{
			...
			valeurParfaiteX=-541; //valeur de X du cadrage parfait
			valeurParfaiteY=-629; //valeur de Y du cadrage parfait
			valeurParfaiteZoom=40; //valeur de Zoom du cadrage parfait
			
			valeurParfaiteXBis=340; //valeur de X du cadrage parfait (deuxième solution)
			valeurParfaiteYBis=-600; //valeur de Y du cadrage parfait (deuxième solution)
			valeurParfaiteZoomBis=46; //valeur de Zoom du cadrage parfait (deuxième solution)
		...
		private function zoom(evt:KeyboardEvent):void // Gère le zoom, la rotation et l'orientation du cadre.
		{
			...
			switch(evt.keyCode)
			{
				...
				case Keyboard.DOWN:
					...
					{
						if(monCadre.width-58<photo.width)
						{
							photo.scaleX=photo.scaleX-0.02;
							photo.scaleY=photo.scaleY-0.02;
							valeurZoom=valeurZoom-2;
