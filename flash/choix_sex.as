...
btn_suivant.txt_suivant.text = MovieClip(racine).DialoguesXML.Gen.BtnSuivant;
btn_annuler.txt_annuler.text = MovieClip(racine).DialoguesXML.Gen.BtnAnnuler;
...
function suivant_new(evt:MouseEvent) {
  MovieClip(racine).adresse = new URLRequest("intro.swf");
