...
//////bruitage/////////////
var pisteBoutique:SoundChannel;
var sonnetteBoutique = new Sound();
var adresseFichierSonBoutique = new URLRequest("./son/boutique.mp3");
sonnetteBoutique.load(adresseFichierSonBoutique);   
...
function ouverture_portes(e){
		...
		pisteBoutique = sonnetteBoutique.play();
}
...
function boutique(e) {
	...
	derriere.masque_boutique.removeEventListener(MouseEvent.CLICK,boutique);
	derriere.masque_grille.removeEventListener(MouseEvent.CLICK,niveau011);
	derriere.masque_boutique.removeEventListener(Event.ENTER_FRAME, interaction_boutique);
	derriere.masque_grille.removeEventListener(Event.ENTER_FRAME, interaction_grille);
